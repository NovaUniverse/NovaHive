package net.novauniverse.games.hive;
...
public class NovaHive extends JavaPlugin implements Listener {
	private static NovaHive instance;

	private Hive game;

	public static NovaHive getInstance() {
		return instance;
	}
